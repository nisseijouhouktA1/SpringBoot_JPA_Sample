 ...
 */
 ...
 // dropdown 初期値上書き
 const selectedOption = Array.from(document.getElementById("impressions")).find((option)=>option.getAttribute("selected"));
 if (selectedOption) {
        document.getElementById("impressions").value = selectedOption.value;
    }
 });